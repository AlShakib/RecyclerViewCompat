/*
 * Copyright (c) 2020 Flute Music Player - All Rights Reserved
 *
 * This file is part of Flute Music Player.
 *
 * Unauthorized copying of this file, via any medium is strictly prohibited.
 * Proprietary and confidential.
 *
 * Written by Al Shakib <shakib@alshakib.dev>
 */
...
public class FastScrollRecyclerView extends RecyclerView
    ...
    private static final String LOG_TAG = FastScrollRecyclerView.class.getSimpleName();
        ...
        private Rect updateFastScrollerBounds(FastScrollRecyclerView recyclerView, int thumbOffsetY) {
            ...
            if (isVisible()) {
                ...
                if (popupPosition == FastScroller.PopupPosition.CENTER) {
                    ...
                    backgroundRect.top = recyclerView.getPaddingTop() - recyclerView.getPaddingBottom() + thumbOffsetY - bgHeight + recyclerView.getScrollBarThumbHeight() / 2;
